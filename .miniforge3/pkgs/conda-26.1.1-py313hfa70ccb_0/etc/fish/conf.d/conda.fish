set -gx CONDA_EXE (cygpath "D:\bld\conda_1772191268282\_h_env\Scripts\conda.exe");
set -gx _CONDA_EXE (cygpath "D:\bld\conda_1772191268282\_h_env\Scripts\conda.exe");
set -e _CE_M || true;
set -e _CE_CONDA || true;
set -gx CONDA_PYTHON_EXE (cygpath "D:\bld\conda_1772191268282\_h_env\python.exe");
set -gx _CONDA_ROOT (cygpath "D:\bld\conda_1772191268282\_h_env");
