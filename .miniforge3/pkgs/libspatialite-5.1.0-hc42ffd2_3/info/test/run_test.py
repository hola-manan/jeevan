#  tests for libspatialite-5.1.0-hc42ffd2_3 (this is a generated file);
print('===== testing package: libspatialite-5.1.0-hc42ffd2_3 =====');
...
# geos 3100 and 3110 not yet available as main geos version is either 3.9 (osx-arm64) or 3.8 (others)
...
db.close()#  --- run_test.py (end) ---

print('===== libspatialite-5.1.0-hc42ffd2_3 OK =====');
